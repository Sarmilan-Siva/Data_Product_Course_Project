...
ui <- fluidPage(
  ...
  headerPanel(
    h1("Demographic Information of Sri Lanka",
       style = "font-family: 'Merriweather', serif;
       font-weight: 500; line-height: 1.1;
       color: #0f542b;")),

  p("This application graphically illustrates the demographic information such as Sex, Ethinicity and Religion of Sri Lanka at district level",
    style = "font-family: 'Merriweather', serif;
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      selectInput("prods", "Group", choices = c("Sex", "Ethinicity", "Religion"), multiple = FALSE),
      checkboxInput("labels", "Show values"),
      helpText('This App is designed to show Sri Lankan demographic information district wise.',
